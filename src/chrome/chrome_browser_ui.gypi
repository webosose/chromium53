...

{
  'variables': {
    ...
    'chrome_browser_ui_views_non_mac_sources': [
      ...
      'browser/ui/views/tabs/window_finder_ozone.cc',
    ...
    'chrome_browser_ui_webos_sources': [
      'browser/ui/webos/chrome_browser_webos_native_event_delegate.cc',
      'browser/ui/webos/chrome_browser_webos_native_event_delegate.h',
    ],
  },
  'targets': [
    {
        ...
        ['use_ozone==1', {
          'conditions': [
            ['ozone_platform_wayland_external==1', {
              'sources': [
                'browser/ui/views/frame/browser_desktop_window_tree_host_ozone_wayland_external.cc',
                'browser/ui/views/frame/browser_desktop_window_tree_host_ozone_wayland_external.h',
              ],
              'dependencies': [
              ...
              'sources': [
                'browser/ui/views/frame/browser_desktop_window_tree_host_ozone_stub.cc',
              ],
            }],
          ],
        }],
