...

{
  'variables': {
    ...
    'chrome_browser_webos_sources': [
      'browser/webos/luna_services.cc',
      'browser/webos/luna_services.h',
    ],
  },
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['OS=="linux" and use_glib==1 and chromeos!=1', {
        ...
        ['webos==1', {
          ...
          'sources': [ '<@(chrome_browser_webos_sources)' ],
        }],
      ],
    },
    {
