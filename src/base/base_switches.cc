...
// Replace images that are not visible on the screen to save memory
const char kDynamicRefetch[] = "dynamic-resource-refetch";

#if defined(OS_WEBOS) && defined(USE_PMLOG)
const char kLogLevelToPmLog[] = "log-level-to-pmlog";
#endif
