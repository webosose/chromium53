...
bool CommandLine::HasDynamicRefetchSwitch() const {
  static bool has_dynamic_refetch_switch = HasSwitch(switches::kDynamicRefetch);
  return has_dynamic_refetch_switch;
}
