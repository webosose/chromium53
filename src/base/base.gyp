  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['enable_lttng==1 and _toolset == "target"', {
          'dependencies': [
            '../build/linux/system.gyp:lttng-ust-headers',
            'lttng_provider',
          ],
	  'defines': [ 'LTTNG_TARGET' ],
        }],
        ...
        ['webos!=0 and _toolset == "target"', {
          'conditions': [
            ['use_pmlog==1', {
              'dependencies': [
                '../build/linux/system.gyp:PmLogLib',
              ],
            }],
            ['use_umediaserver==1', {
              # Apply rtti and exception cppflag needed for timer
              'cflags_cc!': ['-fno-rtti'],
      ...
      'targets': [
        {
          ...
          'sources': [
            'debug/chromium_lttng_provider_dl.c',
            'debug/chromium_lttng_provider.h',
          ],
        },
      ],
    }],
