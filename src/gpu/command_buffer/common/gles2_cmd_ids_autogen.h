...
#define GLES2_COMMAND_LIST(OP)                                       \
  ...
  OP(TexImageIOSurface2DCHROMIUM)                          /* 512 */ \
  ...
  OP(GenSyncTokenCHROMIUMImmediate)                        /* 532 */ \
  OP(GenUnverifiedSyncTokenCHROMIUMImmediate)              /* 533 */ \
  OP(VerifySyncTokensCHROMIUMImmediate)                    /* 534 */ \
