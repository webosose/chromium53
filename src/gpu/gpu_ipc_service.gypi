...

{
  ...
  'conditions': [
    ...
    ['webos==1 and use_webos_surface==1', {
      'dependencies': [
         '../build/linux/system.gyp:webossurface',
      ],
      'sources': [
        'ipc/service/gpu_memory_buffer_factory_webos_surface.cc',
        'ipc/service/gpu_memory_buffer_factory_webos_surface.h',
      ],
    }],
    ['use_ozone == 1', {
      'sources': [
