...
LONG_STRING_CONST(
    ...
    },
    {
      //Add Mali-G* for O18
      "id": 176,
      "description": "The Mali-Gxxx driver does not guarantee flush ordering",
      "gl_vendor": "ARM.*",
      "gl_renderer": "Mali-G.*",
      "features": [
        "use_virtualized_gl_contexts"
    ...
    },
    {
      //Add Mali-4xx
      "id": 177,
      "description": "The Mali-4xx driver does not guarantee flush ordering",
      "gl_vendor": "ARM.*",
      "gl_renderer": "Mali-4.*",
      "features": [
        "use_virtualized_gl_contexts"
    ...
    },
    {
      //Add Mali-4xx
      "id": 178,
      "description": "The Mali-4xx driver does not guarantee complete generating mipmap",
      "gl_vendor": "ARM.*",
      "gl_renderer": "Mali-4.*",
      "features": [
        "force_complete_before_generating_mipmap"
      ]
    }
  ]
}
