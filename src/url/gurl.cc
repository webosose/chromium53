...
#if defined(OS_WEBOS)
    , database_identifier_(other.database_identifier_)
#endif
{
...
#if defined(OS_WEBOS)
  if (SchemeIsFile())
    database_identifier_ = url_string.as_string();
#endif
}
...
#if defined(OS_WEBOS)
  if (SchemeIsFile())
    database_identifier_ = UTF16ToUTF8(url_string.as_string());
#endif
}
...
#if defined(OS_WEBOS)
  if (SchemeIsFile())
    database_identifier_ = url_string;
#endif
}
...
#if defined(OS_WEBOS)
  return (spec_ == other.spec_) && (database_identifier_ == other.database_identifier_);
#else
...
#if defined(OS_WEBOS)
  database_identifier_.swap(other->database_identifier_);
#endif
}
