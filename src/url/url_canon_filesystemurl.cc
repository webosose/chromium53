...
bool DoCanonicalizeFileSystemURL(const CHAR* spec,
  ...
  if (base::CommandLine::ForCurrentProcess()->HasSwitch(
    ...
    // DoCanonicalizeFileSystemURL() is for 'FIle API: Directories and System' and
    // is only validated when switch '--enable-file-api-directories-and-system' is on.
    // Host ID (ex: file://com.webos.app.test/) in file:// scheme must not be removed
    // to enable the feature and to make separated file systems.
