...

{
  ...
  'variables': {
    ...
    'private_browser_sources': [
      ...
      'browser/codecache/codecache_interceptor.cc',
      'browser/codecache/codecache_interceptor.h',
      'browser/codecache/codecache_request_handler.cc',
      'browser/codecache/codecache_request_handler.h',
      'browser/codecache/codecache_url_request_job.cc',
      'browser/codecache/codecache_url_request_job.h',
  ...
  'conditions': [
    ['webos==1', {
      'sources': [
        'browser/webos/render_view_host_webos.h',
        'browser/webos/render_view_host_webos_impl.cc',
        'browser/webos/render_view_host_webos_impl.h',
      ],
    }],
    ['OS != "win"', {
      'sources': [
    ...
    ['webos==1', {
      'sources': [
        'browser/accessibility/webos/accessibility_tree_formatter_webos.cc',
        'browser/accessibility/webos/browser_accessibility_manager_webos.cc',
        'browser/accessibility/webos/browser_accessibility_manager_webos.h',
        'browser/accessibility/webos/browser_accessibility_webos.cc',
        'browser/accessibility/webos/browser_accessibility_webos.h',
        'browser/accessibility/webos/accessibility_localization_webos.cc',
        'browser/accessibility/webos/accessibility_localization_webos.h',
      ],
      'dependencies': [
        '../webos/webos_public.gyp:runtime',
      ],
      'link_settings': {
        'libraries': [
          '-lwebosi18n',
