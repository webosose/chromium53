...
// Pause the audio input stream specified by stream_id.
IPC_MESSAGE_CONTROL1(AudioInputHostMsg_PauseStream, int /* stream_id */)

// Resume the audio input stream specified by stream_id.
IPC_MESSAGE_CONTROL1(AudioInputHostMsg_ResumeStream, int /* stream_id */)
