...
IPC_ENUM_TRAITS(content::ScreenOrientationType)
...
IPC_MESSAGE_ROUTED2(MediaPlayerDelegateMsg_UpdateScreenOrientation,
                    int /* delegate_id, distinguishes instances */,
                    content::ScreenOrientationType /* screen orientation */)
