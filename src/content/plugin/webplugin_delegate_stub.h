...
class WebPluginDelegateStub : public IPC::Listener,
 ...
 private:
  ...
  void OnSuspend();
  void OnResume();
  void OnSetDeviceInfo(const gfx::Size& device_viewport_size,
                       const gfx::Size& view_size);
  void OnAcceleratedPluginDidSwapBuffer(int32_t id);
  void OnAcceleratedPluginDidSwapBufferComplete(int32_t id);
#endif
