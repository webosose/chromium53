...
class CONTENT_EXPORT RenderViewImpl
 ...
 public:
  ...
  bool block_write_diskcache() const { return block_write_diskcache_; }
  ...
  virtual blink::WebString applicationId();
  virtual blink::WebString boardType();
  virtual blink::WebString mediaCodecCapability();
 ...
 private:
  ...
  void OnSuspendDOM();
  void OnResumeDOM();
  void OnContentsPositionChanged(float position);
