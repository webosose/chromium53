...
class CONTENT_EXPORT RenderFrameImpl
 ...
 public:
  ...
  // Dispatch custom event with this name, this function does not handle
  // parameter for event
  static void DispatchCustomEvent(const std::string& eventName);
  ...
  void didHistoryBackOnTopPage(blink::WebFrame* frame) override;
  ...
  std::string GetWebContentUserAgent();
