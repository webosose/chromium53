...
#endif
{
  process_.reset(new BrowserChildProcessHostImpl(
      PROCESS_TYPE_PLUGIN, this, mojo::edk::GenerateRandomToken()));
}
...
bool PluginProcessHost::Init(const WebPluginInfo& info) {
  ...
  static const char* const kSwitchNames[] = {
    ...
    switches::kAllowSendUnblockingPluginMessages,
...
void PluginProcessHost::ShutdownIfIdle()
{
  Send(new PluginProcessMsg_ShutdownIfIdle());
}
