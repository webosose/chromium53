...
class CONTENT_EXPORT BrowserMainLoop {
 public:
  ...
  // Create TimezoneMonitor manually
  // For WebAppManager which is in snapshot, need to create manually
  // If TimeZoneaMonitor is created in snapshot, inotify does not work properly
  void CreateTimeZoneMonitor();
