...
#if defined(OS_WEBOS)
void RenderProcessHostImpl::NotifyLocaleChanged(const std::string& new_locale) {
  Send(new ViewMsg_NotifyLocaleChanged(new_locale));
}
#endif
