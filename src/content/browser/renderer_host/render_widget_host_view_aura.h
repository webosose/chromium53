...
#if defined(OS_WEBOS)
  void ScrollView(const blink::WebMouseWheelEvent& event);
#else
  ui::InputMethod* GetInputMethod() const;
#endif
...
#if defined(OS_WEBOS)
  blink::WebSize hardware_resolution_;
  bool enable_html_systemkeyboard_attr_;
  float window_scale_ratio_;
#endif
