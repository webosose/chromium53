...
class CONTENT_EXPORT WebContentsImpl
 ...
 public:
  ...
  void EnableCompleteAccessibilityMode() override;
  void DisableAccessibilityMode() override;
  ...
  const base::string16& GetDocumentTitle() const override;
  ...
  virtual void AddAvailablePluginDir(const std::string& directory) override;
  virtual const std::vector<std::string>& GetAvailablePluginDirs() const override;
  ...
  void OnWebContentUserAgent(std::string*);
 ...
 private:
...
#if defined(OS_WEBOS)
  friend class WebContentsWebosImpl;
#endif
  ...
  std::vector<std::string> available_plugin_dirs_;
