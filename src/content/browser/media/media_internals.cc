...
class AudioLogImpl : public media::AudioLog {
 public:
  ...
  void OnPaused(int component_id) override;
  void OnResumed(int component_id) override;
...
void AudioLogImpl::OnPaused(int component_id) {
  SendSingleStringUpdate(component_id, kAudioLogStatusKey, "paused");
}

void AudioLogImpl::OnResumed(int component_id) {
  SendSingleStringUpdate(component_id, kAudioLogStatusKey, "resumed");
}
