...
class MediaSession : public WebContentsObserver,
 ...
 public:
  ...
  CONTENT_EXPORT void ScreenOrientationChanged(
 ...
 private:
  ...
  CONTENT_EXPORT void OnScreenOrientationChangeInternal(
      ScreenOrientationType screen_orientation);
  ...
  void SetScreenOrientation(ScreenOrientationType screen_orientation);
