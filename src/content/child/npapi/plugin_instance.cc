...
void PluginInstance::set_punch_hole_for_video(bool value) {
  punch_hole_for_video_ = value;
#if defined(OS_WEBOS)
  webplugin_->SetUsesPunchHoleForVideo(punch_hole_for_video_);
#endif
}
