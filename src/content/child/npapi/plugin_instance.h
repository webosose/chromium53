...
class PluginInstance : public base::RefCountedThreadSafe<PluginInstance> {
 public:
  ...
  // Get/Set whether this instance have external video.
  // Default is false.
  bool punch_hole_for_video() { return punch_hole_for_video_; }
  void set_punch_hole_for_video(bool value);
