...
char* BlinkPlatformImpl::getDynamicRefetchDummy() {
  return GetContentClient()->GetDynamicRefetchDummy();
}

char* BlinkPlatformImpl::getDynamicRefetchDummyFile() {
  return GetContentClient()->GetDynamicRefetchDummyFile();
}
