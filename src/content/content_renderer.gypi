  ...
  'conditions': [
    ...
    ['enable_plugins==1', {
      ...
      'conditions': [
        ...
        ['webos==1', {
          'sources': [
            'renderer/npapi/webplugin_layer_bridge.cc',
            'renderer/npapi/webplugin_layer_bridge.h',
          ],
        }],
      ],
      'dependencies': [
    ...
    ['use_injections!=0', {
      'dependencies': [
        '../injection/injection.gyp:palmsystem_inj',
      ],
    }],
    ['use_injections!=0 and use_dynamic_injection_loading!=0', {
      'sources': [
        'public/renderer/injection/injection_loader_extension_dynamic.cc',
        'public/renderer/injection/injection_loader_extension.h',
      ],
    }],
    ['use_injections!=0 and use_dynamic_injection_loading==0', {
      'sources': [
        'public/renderer/injection/injection_loader_extension_static.cc',
        'public/renderer/injection/injection_loader_extension.h',
      ],
    }],
    ['use_injections!=0', {
      'sources': [
        'public/renderer/injection/injection_base.cc',
        'public/renderer/injection/injection_base.h',
        'public/renderer/injection/injection_data_manager.cc',
        'public/renderer/injection/injection_data_manager.h',
        'renderer/injection/injection_observer.cc',
        'renderer/injection/injection_observer.h',
      ],
    }],
  ],
  'target_conditions': [
