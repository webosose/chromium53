...
{
  'conditions': [
    ['enable_plugins==1 and (OS!="linux" or webos_plugin_support==1)', {
      'dependencies': [
        '../skia/skia.gyp:skia',
      ...
      'conditions': [
        ...
        ['webos==1', {
          'sources': [
            'plugin/webplugin_accelerated_surface_proxy_webos.cc',
            'plugin/webplugin_accelerated_surface_proxy_webos.h',
          ],
        }],
      ],
    }],
