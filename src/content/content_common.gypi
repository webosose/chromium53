...

{
  ...
  'variables': {
    'public_common_sources': [
      ...
      'public/common/screen_orientation_type.h',
    ...
    'lg_common_sources': [
      'common/lg/content_message_generator.h',
      'common/lg/content_message_generator.cc',
      'common/lg/content_message_macros.h',
    ],
  },
  'sources': [
    '<@(public_common_sources)',
  ...
  'conditions': [
    ...
    ['use_injections!=0', {
      'sources': [
        'common/browser_control_messages.h',
        'common/injection_messages.h',
      ],
    }],
  ],
}
