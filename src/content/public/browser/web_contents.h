...
class WebContents : public PageNavigator,
 ...
 public:
  ...
  // Notify the proecess creation of currently active RenderProcessHost
  ...
  // Enable the accessibility completely for this WebContents
  virtual void EnableCompleteAccessibilityMode() = 0;

  // Disable the accessibility
  virtual void DisableAccessibilityMode() = 0;
  ...
  virtual const base::string16& GetDocumentTitle() const = 0;
  ...
  virtual const std::vector<std::string>& GetAvailablePluginDirs() const = 0;

  virtual void ReplaceBaseURL(const GURL& newUrl) = 0;

  virtual void DropAllPeerConnections(DropPeerConnectionReason reason) = 0;
