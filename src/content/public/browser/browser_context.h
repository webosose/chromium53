...
class CONTENT_EXPORT BrowserContext : public base::SupportsUserData {
 public:
  ...
  // If file access is blocked for any reason, it should be set
  // In case of webOS TV, file access is blocked when it is in snapthot boot
  static void SetFileAccessBlocked(bool blocked);
  static bool IsFileAccessBlocked();

private:
  static bool file_access_blocked_;
};
