...
const char kAcceleratedPluginRenderingBlacklist[] =
    "accelerated-plugin-rendering-blacklist";
...
// Allow send unblocking sync plugin messages not only during unblock dispatch.
const char kAllowSendUnblockingPluginMessages[] =
    "allow-send-unblocking-plugin-messages";

// Disk cache limit for the ApplicationCache. Default value is 262144000 (250Mb).
const char kApplicationCacheSize[]          = "application-cache-size";

// Limit size for ApplicationCache per domain.
const char kAppCacheSizePerDomain[]         = "application-cache-domain-limit";
...
// Enables accelerated rendering for NPAPI plugins.
const char kEnableAcceleratedPluginRendering[] =
    "enable-accelerated-plugin-rendering";

// Enables npapi visual plugins.
const char kEnableNpapiVisualPlugins[] = "enable-npapi-visual-plugins";
...
const char kEnableFileAPIDirectoriesAndSystem[]  = "enable-file-api-directories-and-system";
...
const char kWatchdogRenderPeriod[]          = "watchdog-render-period";
const char kWatchdogRenderTimeout[]         = "watchdog-render-timeout";
...
// Close WebRTC peer connections on page hidden.
const char kWebRTCDisconnectPeersOnPageHidden[] =
    "webrtc-disconnect-peer-on-page-hidden";
#endif
...
// memory cache size in skia side
const char kSkiaImageCacheSizeMb[]        = "skia-image-cache-size-mb";
