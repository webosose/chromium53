...
IPC_STRUCT_TRAITS_BEGIN(content::WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(force_video_texture)
  IPC_STRUCT_TRAITS_MEMBER(is_audio_guidance)
  IPC_STRUCT_TRAITS_MEMBER(audio_guidance_on)
  ...
  IPC_STRUCT_TRAITS_MEMBER(accessibility_explore_by_mouse_enabled)
  ...
  IPC_STRUCT_TRAITS_MEMBER(allow_mouse_on_off_event)
