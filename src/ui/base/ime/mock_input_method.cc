...
gfx::Rect MockInputMethod::GetInputPanelRect() const {
  return gfx::Rect(0, 0, 0, 0);
}

gfx::Rect MockInputMethod::GetCaretBounds() const {
  return gfx::Rect(0, 0, 0, 0);
}

bool MockInputMethod::IsVisible() const {
  return false;
}

bool MockInputMethod::IsInputMethodActive() const {
  return false;
}
