...
class EVENTS_EXPORT Event {
 public:
  ...
  EventSourceType event_source_type() const { return event_source_type_; }
  void set_event_source_type(EventSourceType type) {
    event_source_type_ = type;
  }
 ...
 private:
  ...
  EventPhase phase_;
  EventResult result_;
  EventSourceType event_source_type_;
