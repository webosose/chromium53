...
// Device Type for keyboard, VKB and NRCU Key Events.
...
// IME hidden types introduced for WebOS VKB
enum ImeHiddenType {
  IME_ACTIVE,    // VKB shouldn't be deactivated
  IME_CLOSE,     // VKB shouldn't be reactivated on focus
  IME_RESTORE    // VKB should be reactivated on focus
};
