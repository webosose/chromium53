...
COMPOSITOR_EXPORT extern const char kUIDisableOpaqueShaderProgram[];
...
COMPOSITOR_EXPORT extern const char kEnableAggressiveReleasePolicy[];
COMPOSITOR_EXPORT extern const char kUIUsePrepareShaderProgram[];
