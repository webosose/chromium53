...
# webos uses a very minimized set of locales add the path here to discover and
# import the repack_locales script
sys.path.insert(1, os.path.join(chrome_src, 'webos', 'tools', 'build'))
