...
// Currently, webOS doesn't require to get user consent to access media
// capture devices. So this singleton simply grabs some capture devices
// and calls callback with them.
