...
#ifndef PAL_PUBLIC_PAL_H_
#define PAL_PUBLIC_PAL_H_

#include "lg/pal/common/pal_export.h"

namespace pal {

// Singleton class. Provides public access to following interfaces.
