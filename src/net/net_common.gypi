...

{
  ...
  'conditions': [
    ['webos==1', {
      'sources' : [
          'base/webos/network_change_notifier_factory_webos.cc',
          'base/webos/network_change_notifier_factory_webos.h',
          'base/webos/network_change_notifier_webos.cc',
          'base/webos/network_change_notifier_webos.h',
      ],
    }],
    ['chromeos==1', {
      'sources!': [
    ...
    [ 'use_openssl_certs == 0', {
        'sources!': [
          ...
          'ssl/ssl_platform_key_openssl.cc',
        ],
    }],
    [ 'use_glib == 1', {
        'dependencies': [
