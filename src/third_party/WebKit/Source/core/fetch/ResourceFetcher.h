...
public:
    ...
    bool localResourceCodeCacheEnabled() const { return m_localResourceCodeCacheEnabled; }
    void setLocalResourceCodeCacheEnabled(bool);

    bool codeCacheFromFileURIsWithQueryStringDisallowed() const { return m_codeCacheFromFileURIsWithQueryStringDisallowed; }
...
private:
    ...
    bool m_localResourceCodeCacheEnabled : 1;
    bool m_codeCacheFromFileURIsWithQueryStringDisallowed : 1;
};
