...
public:
    ...
    void didUnloadTimerFired(Timer<FrameView>*);
    ...
    void onlyVisibleImageInMemory();
    void updateAbsolutePosition();
    int getAbsoutePosition() { return m_framePosition; };
...
private:
    ...
    int m_lastUnloadPosition;
    int m_unloadCount;
    Timer<FrameView> m_unloadTimer;
    bool m_scrollTo;
    int m_framePosition;
};
