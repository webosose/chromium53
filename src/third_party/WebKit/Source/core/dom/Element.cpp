...
bool Element::isPreventScrollOnFocus()
{
    ...
    if (value != nullAtom && equalIgnoringCase(value, "true") && document().settings()->webOSNativeScrollEnabled())
        return true;
    return false;
}
...
void Element::focus(const FocusParams& params)
{
    ...
    if (document().focusedElement() == this && (UserGestureIndicator::processedUserGestureSinceLoad()  || (params.type == WebFocusTypeNone && hasAttribute(autofocusAttr)))) {
