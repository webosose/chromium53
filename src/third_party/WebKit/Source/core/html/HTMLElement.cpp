...
const AtomicString& HTMLElement::eventNameForAttributeName(const QualifiedName& attrName)
{
    ...
    if (!attributeNameToEventNameMap.size()) {
        ...
        AttrToEventName attrToEventNames[] = {
            ...
            { onbroadcasterrormsgAttr, EventTypeNames::broadcasterrormsg },
            ...
            { ondvrerrormsgAttr, EventTypeNames::dvrerrormsg },
            ...
            { onpipelinestartedAttr, EventTypeNames::pipelinestarted },
            ...
            { onumsmediainfoAttr, EventTypeNames::umsmediainfo },
            { onupdatecamerastateAttr, EventTypeNames::updatecamerastate },
            ...
            { onmouseonAttr, EventTypeNames::mouseon },
            { onmouseoffAttr, EventTypeNames::mouseoff },
        };
...
int HTMLElement::updateImages(int scrollOffset, std::vector<HTMLImageElement*>& imageElements)
{
    int count = 0;
