...
private:
    ...
    Document* document();
    void networkStableTimerFired(Timer<FirstMeaningfulPaintDetector>*);
    void notifyFMPDetectTimerFired(Timer<FirstMeaningfulPaintDetector>*);
#if defined(OS_WEBOS)
    ...
    Timer<FirstMeaningfulPaintDetector> m_notifyFMPDetectTimer;
};
