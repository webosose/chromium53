...
#include "core/style/StyleNavData.h"
...
// attribute setter methods
    ...
    const StyleNavData* nav(int propId) const;
    StyleNavData* accessNav(int propId);
    const StyleNavIndex* navIndex() const { return rareNonInheritedData->m_navIndex.get(); }
    StyleNavIndex* accessNavIndex();
    void inheritNav(int propId, const ComputedStyle* inheritParent);
