...
static const char* const gUnicodeRangeToLangTable[] = {
    0,
    "el",
    "tr",
    "he",
...
const char* guessLangFromUnicodeRange(unsigned char unicodeRange)
{
    if (cRangeSpecificItemNum > unicodeRange)
        return gUnicodeRangeToLangTable[unicodeRange];
    return 0;
}
