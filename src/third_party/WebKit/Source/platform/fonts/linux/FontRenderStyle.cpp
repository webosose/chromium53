...
// static
void FontRenderStyle::setAllowFakeBoldText(bool allowFakeBoldText)
{
    useSkiaFakeBoldText = allowFakeBoldText;
}

// static
bool FontRenderStyle::getAllowFakeBoldText()
{
    return useSkiaFakeBoldText;
}
