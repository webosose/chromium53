...
public:
    ...
    static std::unique_ptr<CompositorScrollOffsetAnimationCurve> create(FloatPoint targetValue, CompositorScrollOffsetAnimationCurve::ScrollDurationBehavior durationBehavior, CompositorScrollOffsetAnimationCurve::ScrollEaseType easeType)
    {
        return wrapUnique(new CompositorScrollOffsetAnimationCurve(targetValue, durationBehavior, easeType));
    }
...
private:
    CompositorScrollOffsetAnimationCurve(FloatPoint, ScrollDurationBehavior, ScrollEaseType);
