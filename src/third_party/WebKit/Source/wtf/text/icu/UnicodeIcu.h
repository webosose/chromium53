...
enum PairedBracketType {
    PairedBracketNone = U_BPT_NONE,
    PairedBracketOpen = U_BPT_OPEN,
    PairedBracketClose = U_BPT_CLOSE,
};
...
inline PairedBracketType pairedBracketType(UChar32 c)
{
    return static_cast<PairedBracketType>(u_getIntPropertyValue(c, UCHAR_BIDI_PAIRED_BRACKET_TYPE));
}
