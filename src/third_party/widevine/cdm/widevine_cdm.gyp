...

{
  'variables': {
    ...
    'conditions': [
      ...
      [ 'OS == "linux" and webos==1', {
        'widevine_cdm_version_h_file%':
            'webos/widevine_cdm_version.h',
      }],
    ],
  },
  'includes': [
  ...
  'targets': [
    ...
    },
    {
      ...
      'type': 'none',
      'conditions': [
        [ '(branding == "Chrome" or enable_widevine_cdm == 1) and enable_pepper_cdms == 1', {
          'dependencies': [
          ...
          'conditions': [
            ...
            [ 'OS == "linux" and webos==1 and target_arch=="arm"', {
              'libraries': [
                # libwidevinecdm.so gets installed by the widevine-modular
                # binary package, and gets copied by the widevinecdm target
                '<(PRODUCT_DIR)/<(widevine_cdm_path)/libwidevinecdm.so',
              ],
            }], {
