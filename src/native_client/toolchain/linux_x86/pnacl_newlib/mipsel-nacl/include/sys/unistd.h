...
#ifndef EXPORT_SRC_TRUSTED_SERVICE_RUNTIME_INCLUDE_SYS_UNISTD_H_
#define EXPORT_SRC_TRUSTED_SERVICE_RUNTIME_INCLUDE_SYS_UNISTD_H_
...
int     _EXFUN(_execve, (const char *__path, char * const __argv[], char * const __envp[] ));
    ...
    || defined(__SPU__) || (1 /* NACL_IN_TOOLCHAIN_HEADERS */)
#if !defined(__INSIDE_CYGWIN__)
...
#define _SC_PAGESIZE _SC_PAGESIZE
  _SC_NACL_CPU_FEATURE_X86 = 1 << 16,
#define _SC_NACL_CPU_FEATURE_X86 \
    _SC_NACL_CPU_FEATURE_X86

  /*
   * The sysconf values below are not part of the stable ABI.
   */
  _SC_NACL_FILE_ACCESS_ENABLED = 1 << 24,
#define _SC_NACL_FILE_ACCESS_ENABLED \
    _SC_NACL_FILE_ACCESS_ENABLED
  _SC_NACL_LIST_MAPPINGS_ENABLED,
#define _SC_NACL_LIST_MAPPINGS_ENABLED \
    _SC_NACL_LIST_MAPPINGS_ENABLED
  _SC_NACL_PNACL_MODE,
#define _SC_NACL_PNACL_MODE \
    _SC_NACL_PNACL_MODE
};
