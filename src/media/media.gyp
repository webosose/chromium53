...

{
  ...
  'targets': [
    ...
    {
      'target_name': 'decrypting_demuxer',
      'type': 'static_library',
      'include_dirs': [
        '..',
      ],
      ...
      'conditions': [
        ['enable_lg_svp==1', {
          # rtti is needed for the inband serializer
          # we turn in on only on the files that we need
          # by grouping those files into a static library target
          'cflags_cc!': ['-fno-rtti'],
          'cflags_cc+': ['-frtti'],
        }],
        [ 'enable_pepper_cdms==1 and enable_widevine_cdm==1', {
          'dependencies': [
    ...
    },
    {
      ...
      'conditions': [
        ...
        ['webos!=0 and use_umediaserver==1', {
          'sources': [
            'webos/base/lunaservice_client.cc',
            'webos/base/lunaservice_client.h',
            'webos/base/media_apis_wrapper.cc',
            'webos/base/media_apis_wrapper.h',
            'webos/filters/tv_audio_decoder.cc',
            'webos/filters/tv_audio_decoder.h',
            'webos/filters/tv_video_decoder.cc',
            'webos/filters/tv_video_decoder.h',
            'webos/renderers/tv_renderer_factory.cc',
            'webos/renderers/tv_renderer_factory.h',
            'webos/renderers/tv_video_renderer.cc',
            'webos/renderers/tv_video_renderer.h',
          ],
          'dependencies': [
