...
enum PipelineStatus {
  ...
  DECODER_ERROR_RESOURCE_IS_RELEASED = 17,
  // ChunkDemuxer related errors.
  CHUNK_DEMUXER_ERROR_APPEND_FAILED = 18,
  CHUNK_DEMUXER_ERROR_EOS_STATUS_DECODE_ERROR = 19,
  CHUNK_DEMUXER_ERROR_EOS_STATUS_NETWORK_ERROR = 20,

  // Audio rendering errors.
  AUDIO_RENDERER_ERROR = 21,
  AUDIO_RENDERER_ERROR_SPLICE_FAILED = 22,
