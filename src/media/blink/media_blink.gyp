  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['webos!=0 and use_umediaserver==1', {
          'dependencies': [
            '../../build/linux/system.gyp:mdc_content_provider',
            '../../build/linux/system.gyp:luna-service2',
            '../../build/linux/system.gyp:umedia_api',
            '../../third_party/jsoncpp/jsoncpp.gyp:jsoncpp',
          ],
          'sources': [
            'webos/media_info_loader.cc',
            'webos/media_info_loader.h',
            'webos/umediaclient_impl.cc',
            'webos/umediaclient_impl.h',
            'webos/webmediaplayer_ums.cc',
            'webos/webmediaplayer_ums.h',
            'webos/webmediaplayer_mse.cc',
