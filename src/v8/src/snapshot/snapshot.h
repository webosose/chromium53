...
class SnapshotData : public SerializedData {
 ...
 private:
  ...
  int compress(const byte* data, const int length, byte* compressed);
  ...
  static const int kCompressionTypeOffset = kNumReservationsOffset + kInt32Size;
  static const int kCompressedLengthOffset =
      kCompressionTypeOffset + kInt32Size;
  static const int kPayloadLengthOffset = kCompressedLengthOffset + kInt32Size;
