...
#undef NATIVE_CONTEXT_FIELD_ACCESSOR
  ...
  void SetLaunchState(v8::Isolate::LaunchStateType launch_state) {
    DCHECK(launch_state != v8::Isolate::kBeforeLaunch);
    launch_state_ = launch_state;
  }

  v8::Isolate::LaunchStateType LaunchState() const { return launch_state_; }
 ...
 private:
  ...
  // default is kBeforeLaunch
  v8::Isolate::LaunchStateType launch_state_;
