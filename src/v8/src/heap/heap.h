...
#undef ROOT_INDEX_DECLARATION
  ...
  static const int kMaxSemiSpaceSizeUltraLowMemoryDevice = 1 * kPointerMultiplier;
  ...
  // Sizes are in MB.
  static const int kMaxOldSpaceSizeUltraLowMemoryDevice = 32 * kPointerMultiplier;
  ...
  // Sizes are in MB.
  static const int kMaxExecutableSizeUltraLowMemoryDevice = 16 * kPointerMultiplier;
