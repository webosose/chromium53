...
class V8_EXPORT Script {
 public:
  ...
  static bool CompileExtension(Isolate* isolate, Local<String> source, Extension* extension);
...
class V8_EXPORT ResourceConstraints {
 public:
  ...
  size_t high_fragmentation_slack() const {
    return high_fragmentation_slack_;
  }
...
class V8_EXPORT Isolate {
 public:
  ...
  enum LaunchStateType {
    kBeforeLaunch,
    kLaunching,
    kLaunched
  };

  void SetLaunchOptimization(bool enabled);
